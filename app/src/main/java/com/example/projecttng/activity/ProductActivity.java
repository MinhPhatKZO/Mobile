...
public class ProductActivity extends AppCompatActivity {
    ...
    private void loadProducts() {
        ...
        productList.add(new FoodItem("Bún bò", "Hamburger bò Mỹ đặc biệt", "950kcal", "45.000đ", "30min", R.drawable.bunbo, 120, 9, 4.4f, FoodItem.FoodType.FOOD));
        productList.add(new FoodItem("Bánh mì", "Kem tươi mát lạnh vị dâu", "300kcal", "20.000đ", "5min", R.drawable.banhmi, 60, 6, 4.6f, FoodItem.FoodType.FOOD));
